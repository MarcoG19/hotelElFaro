...
function msjeWsp() {
	...
	var fec_llegada = document.getElementById('date-in').value;
	var fec_salida = document.getElementById('date-out').value;
	var adulto = document.getElementById('adulto').value;
	var nino = document.getElementById('nino').value;

	if (nombre != "" && fec_llegada != "" && fec_salida != "") {
		window.open('https://api.whatsapp.com/send?phone=51935693342&text=Quiero%20un%20cuarto%20//%20Mi%20nombre%20es%20'+nombre+
		'%20/%20Fecha%20de%20llegada%20:%20'+fec_llegada+'%20/%20Fecha%20de%20salida%20:%20'+fec_salida+'%20/%20Sería%20'+adulto+'%20adultos%20y%20'+nino+'%20niños', '_blank');
...
function reservaWsp() {
	window.open('https://api.whatsapp.com/send?phone=51935693342&text=Buenos días, estoy interesado','_blank');
}
